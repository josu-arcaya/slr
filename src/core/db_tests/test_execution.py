...
class TestSqlAlchemyORM(unittest.TestCase):
    ...
    def test_init(self):
        self.assertIsNotNone(self.orm.db._engine, "Error en __init__: 'Engine' no se ha inicializado correctamente")
        self.assertIsNotNone(self.orm.db._Session, "Error en __init__: 'Session' se ha inicializado correctamente")
    ...
    def test_set_get_publisher_by_issn(self):
        ...
        self.assertIsNotNone(result, "Error en set_publisher_by_issn / get_publisher_by_issn")
    ...
    def test_get_all_issn_without_publisher(self):
        ...
        print(f" Resultado de test_get_all_issn_without_publisher: {result_issn_without_publisher}\n")

        expected_result = [("EID3", "ISSN3", "EISSN3")]
        self.assertEqual(result_issn_without_publisher, expected_result, "Error en get_all_issn_without_publisher")
